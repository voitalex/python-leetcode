...
class Solution:
    ...
    def start_position(self) -> Position:
        """ Возвращает координаты стартового положения """
        return Position(0, 0)

    def next_position(self, position: Position, move: str) -> Position:
        """ Возвращает следующее положение робота исхода из команды и текущего положения """
    ...
    def judgeCircle(self, moves):
        ...
        for move in moves:
            position = self.next_position(position, move)
